...
function renderPlayers() {
    ...
    thead.innerHTML = `
        <tr>
            <th class="col-checkbox"><input type="checkbox" id="select-all-players"></th>
    ...
    // Select all logic
    const selectAllCheckbox = thead.querySelector('#select-all-players');
    selectAllCheckbox.addEventListener('change', (e) => {
        const isChecked = e.target.checked;
        const rowCheckboxes = tbody.querySelectorAll('.row-checkbox');
        rowCheckboxes.forEach(cb => {
            if (cb.checked !== isChecked) {
                cb.click(); // Trigger click to update internal state and UI properly
            }
        });
    });
    ...
    playersData.forEach(player => {
        ...
        tr.innerHTML = `
            <td class="col-checkbox"><input type="checkbox" class="row-checkbox" id="p-${player.id}"></td>
            ...
            <td class="col-comment">${player.comment || ''}</td>
        `;
        
        const checkbox = tr.querySelector('.row-checkbox');
        const strengthInput = tr.querySelector('.strength-input');
